  ...
  <div class="container py-4">
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="form-text">Por exemplo: Programdor JavaScript e VueJs.</div>
      </div>
    </div>
    ...
    <div class="row mt-3">
      ...
      <div class="col">
        ...
        <div class="form-text">Informe onde da atividades serão realizadas</div>
      </div>
      ...
      <div class="col">
        ...
        <div class="form-text">Informe o tipo de contrataçaõ</div>
      </div>
    </div>

    <div class="row mt-3">
      <div class="col">
        <button type="submit" class="btn btn-outline-primary" @click="salvarVaga()">Cadastrar</button>
      </div>
    </div>
  </div>
</template>
        ...
        salvarVaga() {
          ...
          if (this.validaFormulario()) {
            ...
            this.emitter.emit('alerta', {
              ...
              descricao: 'Parabéns sua  vaga foi cadastrada com sucesso, e poderá ser consultada por milhares de profissionais em nossa plataforma'
          })

          this.resetarCadastroVaga()
            ...
            this.emitter.emit('alerta', {
              ...
              descricao: 'Parece que esqueceu de preencher uma informação obrigatoria da vaga. Faça o seu ajuste e tente novamente, obrigado!!'
          })
        }    
      },
        resetarCadastroVaga(){
